...
async def build_tool_registry(
    ...
    Args:
        ...
        vision_tool: When true, ``see_screen`` is registered so a text-only
            agent can ask a vision model to look at the current screen.
            Requires ``ActionContext.vision_llm`` to be set.
